...
for i in range(15,51):
    ...
    # driver.get(f"https://www.justdial.com/Nagpur/Ayurvedic-Doctors/nct-10029616/page-{pagenum}")
    driver.get(f"https://www.justdial.com/Nagpur/Clothes-Retailers-in-Hingna/nct-10401947")
    # type = f""
